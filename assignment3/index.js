(function(){
	...
	function main() {
		...
		var Outline = [
			-0.5, -0.5,  0.1, 	0.0, 1.0, 0.0,//b
			-0.5,  0.5,  0.1, 	1.0, 1.0, 0.0,//a
			-0.3, -0.5,  0.1, 	0.0, 1.0, 1.0,//c
			-0.3,  0.5,  0.1, 	0.0, 1.0, 0.0,//d
			-0.5, -0.5, -0.1, 	1.0, 1.0, 0.0,//b
			-0.5,  0.5, -0.1, 	0.0, 1.0, 1.0,//a
			-0.3, -0.5, -0.1, 	0.0, 1.0, 1.0,//c
			-0.3,  0.5, -0.1, 	1.0, 1.0, 0.0,//d
			-0.5, -0.5,  0.1, 	0.0, 1.0, 1.0,//b
			-0.5, -0.5, -0.1, 	1.0, 1.0, 0.0,//b
			-0.5,  0.5,  0.1, 	0.0, 1.0, 1.0,//a
			-0.5,  0.5, -0.1, 	0.0, 1.0, 0.0,//a
			-0.3, -0.5,  0.1, 	0.0, 1.0, 1.0,//c
			-0.3, -0.5, -0.1, 	1.0, 1.0, 0.0,//c
			-0.3,  0.5,  0.1, 	0.0, 1.0, 1.0,//d
			-0.3,  0.5, -0.1, 	0.0, 1.0, 1.0,//d
			-0.5, -0.5,  0.1, 	1.0, 1.0, 0.0,//b
			-0.3, -0.5,  0.1, 	0.0, 1.0, 1.0,//c
			-0.5,  0.5,  0.1, 	1.0, 1.0, 0.0,//a
			...
			-0.3, 0.3,  0.1, 	0.0, 1.0, 1.0,//e
			-0.3, 0.5,  0.1, 	0.0, 1.0, 1.0,//d
			 0.0, 0.1,  0.1, 	0.0, 1.0, 0.0,//f
			 0.0, 0.3,  0.1, 	0.0, 1.0, 0.0,//g
			-0.3, 0.3, -0.1, 	0.0, 1.0, 1.0,//e
			-0.3, 0.5, -0.1, 	0.0, 1.0, 1.0,//d
			 0.0, 0.1, -0.1, 	0.0, 1.0, 0.0,//f
			 0.0, 0.3, -0.1, 	0.0, 1.0, 0.0,//g
			...
			0.0, 0.1,  0.1, 	1.0, 1.0, 0.0,//f
			0.0, 0.3,  0.1, 	1.0, 1.0, 0.0,//g
			0.3, 0.3,  0.1, 	1.0, 1.0, 0.0,//h
			0.3, 0.5,  0.1, 	1.0, 1.0, 0.0,//i
			0.0, 0.1, -0.1, 	1.0, 1.0, 0.0,//f
			0.0, 0.3, -0.1, 	1.0, 1.0, 0.0,//g
			0.3, 0.3, -0.1, 	1.0, 1.0, 0.0,//h
			0.3, 0.5, -0.1, 	1.0, 1.0, 0.0,//i
			...
			0.3, -0.5,  0.1, 	0.0, 1.0, 0.0,//l
			0.3,  0.5,  0.1, 	1.0, 1.0, 0.0,//i
			0.5, -0.5,  0.1, 	0.0, 1.0, 1.0,//k
			0.5,  0.5,  0.1, 	0.0, 1.0, 0.0,//j
			0.3, -0.5, -0.1, 	1.0, 1.0, 0.0,//l
			0.3,  0.5, -0.1, 	0.0, 1.0, 1.0,//i
			0.5, -0.5, -0.1, 	0.0, 1.0, 0.0,//k
			0.5,  0.5, -0.1, 	1.0, 1.0, 0.0,//j
			0.3, -0.5,  0.1, 	0.0, 1.0, 1.0,//l
			0.3, -0.5, -0.1, 	0.0, 1.0, 0.0,//l
			0.3,  0.5,  0.1, 	1.0, 1.0, 0.0,//i
			0.3,  0.5, -0.1, 	0.0, 1.0, 1.0,//i
			0.5, -0.5,  0.1, 	0.0, 1.0, 0.0,//k
			0.5, -0.5, -0.1, 	1.0, 1.0, 0.0,//k
			0.5,  0.5,  0.1, 	0.0, 1.0, 1.0,//j
			0.5,  0.5, -0.1, 	0.0, 1.0, 0.0,//j
			0.3, -0.5,  0.1, 	1.0, 1.0, 0.0,//l
			0.5, -0.5,  0.1, 	0.0, 1.0, 1.0,//k
			0.3,  0.5,  0.1, 	0.0, 1.0, 0.0,//i
			0.5,  0.5,  0.1, 	1.0, 1.0, 0.0,//j
			0.3, -0.5, -0.1, 	0.0, 1.0, 1.0,//l
			0.5, -0.5, -0.1, 	0.0, 1.0, 0.0,//k
			0.3,  0.5, -0.1, 	1.0, 1.0, 0.0,//i
